...
class RunManager:
    ...
    def __init__(
        ...
        context_preprocess_prompt_path_common: str = "agents/prompts/context_preprocess/common.system.txt",
        context_preprocess_prompt_path_per_file: str = "agents/prompts/context_preprocess/per_file.system.txt",
        context_preprocess_prompt_path_aggregate: str = "agents/prompts/context_preprocess/aggregate.system.txt",
        ...
        self._context_preprocess_prompt_path_per_file = str(
            ...
            or "agents/prompts/context_preprocess/per_file.system.txt"
        )
        self._context_preprocess_prompt_path_aggregate = str(
            context_preprocess_prompt_path_aggregate
            or "agents/prompts/context_preprocess/aggregate.system.txt"
        )
    ...
    def _context_prompt_text(self, kind: str) -> str:
        ...
        fallback = load_prompt("context_preprocess_common.system.txt")
